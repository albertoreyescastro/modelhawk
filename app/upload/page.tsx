      ...
      <section className="relative z-10 mx-auto grid max-w-7xl items-start gap-12 px-6 py-16 lg:grid-cols-[0.85fr_1.15fr]">
        <div>
          <div className="mb-6 inline-flex rounded-full border border-blue-400/30 bg-blue-500/10 px-4 py-2 text-sm text-blue-100">
            Static audit + local AI examiner
          </div>
          ...
          <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-300">
            ...
            technical audit checks and then uses a local AI examiner layer to
          ...
          <div className="mt-8 grid gap-3 text-sm text-slate-400">
            ...
            <InfoBox text="The AI examiner notes are generated locally with Ollama using the audit result as evidence." />
          </div>
        </div>
        ...
        <div className="rounded-[2rem] border border-white/10 bg-white/[0.06] p-6 shadow-2xl shadow-blue-950/80 backdrop-blur">
          <div className="rounded-[1.5rem] bg-[#050B18] p-6">
            ...
            <p className="mt-3 text-sm leading-6 text-slate-400">
              ...
              technical signals, generate risk scores and add local AI examiner
              notes.
            </p>
        ...
        <div className="mb-5 flex flex-col justify-between gap-4 sm:flex-row sm:items-start">
          <div>
            <h4 className="text-xl font-black text-white">
              Local AI technical review
            </h4>
            <p className="mt-2 text-sm leading-6 text-slate-300">
              Generated by your local Ollama model using the deterministic
      ...
      <div className="mb-4 flex items-center justify-between gap-4">
        <div>
          <p className="text-sm font-bold text-cyan-200">
            Generating local AI examiner notes...
          </p>
          <p className="mt-1 text-xs text-slate-400">
            Ollama is reading the audit JSON and writing a technical review.
          </p>
        </div>
