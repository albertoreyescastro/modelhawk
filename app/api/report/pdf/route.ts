...
\\textbf{Audit type:} Static notebook analysis with optional AI examiner notes\\\\
...
% AI examiner notes
% ==================================================
\\section*{AI Examiner Notes}

\\noindent\\fcolorbox{mainyellow}{softyellow}{
\\begin{minipage}{0.95\\textwidth}
No AI examiner narrative was included in this PDF request. The deterministic static audit sections above were still generated successfully.
\\end{minipage}
}
`;
  }
...
\\noindent\\fcolorbox{mainpurple}{softpurple}{
\\begin{minipage}{0.95\\textwidth}
\\textbf{AI technical review.} These notes were generated by a configured AI provider using the deterministic ModelHawk audit as evidence. They should be treated as explanatory support, not as proof that the notebook is correct.
\\end{minipage}
}
